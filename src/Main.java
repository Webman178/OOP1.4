...
//        moskvich.refill();
        ...
        Car kia = new Car("Киа ", "Сид", 1.8);
        Car ford = new Car("Форд ", "Фокус", 1.6);
        Car chevrolet = new Car("Шевроле ", "Лачетии", 1.5);

        Truck bmw = new Truck("БМВ ", "Пегас", 4.6);
        Truck volvo = new Truck("Волво ", "Империал", 5.0);
        Truck kamaz = new Truck("Камаз ", "Столб", 4.0);
        Truck hyundai = new Truck("Хендэ ", "Дракслер", 4.8);

        Bus toyota = new Bus("Тойота ", "Мэн", 3.6);
        Bus volga = new Bus("Волга ", "ВР-1", 4.0);
        Bus moskvich = new Bus("Москвич ", "ПА-9", 3.5);
        Bus lendRover = new Bus("Ленд Ровер ", "НК-12", 4.6);
